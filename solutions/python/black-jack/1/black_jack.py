...
def higher_card(card_one, card_two):
    ...
    return card_one if v_one > v_two else card_two
...
def value_of_ace(card_one, card_two):
    ...
    # Guard: if either card is already 'A' return 1
    ...
    current_score = v_one + v_two

    if current_score + 1 == 21:
        return 1
    elif current_score + 11 > 21:
        return 1
